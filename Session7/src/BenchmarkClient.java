...
public class BenchmarkClient {
    ...
    private static void setWorkloadMix () {
        ...
        for (int i = 6; i < noRequests; i = i + 16) {
            ...
            workloadMix[i] = "http://localhost:8000/direktkandidatengewinner/122/2018";
        }
    ...
    private static int [] averagePerformances () {
        ...
        averagePerformances[9] = sum06 / counter06;
    ...
    private static void generateLineCharts () {
        ...
        int [] xValuesClients = new int [6];
        int [] xValuesTime = new int [6];
        xValuesClients[0] = 1;
        xValuesClients[1] = 2;
        xValuesClients[2] = 4;
        xValuesClients[3] = 8;
    ...
    public static void main (String [] args) {
        ...
        overallPerformance = new int [10][6][6];

        for (int i = 0; i < 6; i++) {
            for (int j = 0; j < 6; j++) {
                noClients = (int) Math.pow(2, i);
                meanWaitTime = 1000 * (j + 2);
