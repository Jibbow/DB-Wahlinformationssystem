CREATE PROCEDURE WIS.GET_STIMMVERTEILUNG (IN _perform_on_aggregates BOOLEAN, IN _jahr INT, IN _stimmkreis INT,
OUT _out TABLE (
    PARTEI NVARCHAR(20),
    GESAMTSTIMMEN INT,
    PROZENT N_DOUBLE
...
READS SQL DATA WITH RESULT VIEW PROC_STIMMVERTEILUNG AS
BEGIN
