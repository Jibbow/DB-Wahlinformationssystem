 ...
 */
CREATE PROCEDURE WIS.GET_DIREKTKANDIDATENGEWINNER (IN _perform_on_aggregates BOOLEAN, IN _jahr INT, IN _stimmkreis INT,
OUT _out TABLE (
    ID INT,
    VORNAME NVARCHAR(26),
...
READS SQL DATA WITH RESULT VIEW PROC_DIREKTKANDIDATENGEWINNER AS
BEGIN
...
WHERE S.STIMMKREIS=:_stimmkreis AND S.JAHR=:_jahr
