CREATE PROCEDURE WIS.GET_SIEGERPARTEI_ERSTSTIMMEN (IN _perform_on_aggregates BOOLEAN, IN _jahr INT, IN _stimmkreis INT,
OUT _out TABLE (
    PARTEI NVARCHAR(20),
    ANZAHLERSTSTIMMEN INT)) 
LANGUAGE SQLSCRIPT
SQL SECURITY INVOKER
READS SQL DATA WITH RESULT VIEW PROC_SIEGERPARTEI_ERSTSTIMMEN AS
BEGIN
...
SELECT P.ABKUERZUNG AS PARTEI, GES.GESAMTERSTSTIMMEN AS ANZAHLERSTSTIMMEN
