...
SELECT P13.ABKUERZUNG AS PARTEI, S18.STIMMENABSOLUT - COALESCE(S13.STIMMENABSOLUT, 0) AS DIFF_ABSOLUT, S18.STIMMENRELATIV - COALESCE(S13.STIMMENRELATIV, 0) AS DIFF_PROZENT
FROM STATISTIK_2018 S18 JOIN WIS.PARTEI P18 ON S18.PARTEI=P18.ID
    LEFT OUTER JOIN WIS.PARTEI P13 ON P13.ABKUERZUNG=P18.ABKUERZUNG
