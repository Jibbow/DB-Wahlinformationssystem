 ...
 */
SELECT P18.ABKUERZUNG AS PARTEI, S18.STIMMENABSOLUT - COALESCE(S13.STIMMENABSOLUT, 0) AS DIFF_ABSOLUT, S18.STIMMENRELATIV - COALESCE(S13.STIMMENRELATIV, 0) AS DIFF_PROZENT
